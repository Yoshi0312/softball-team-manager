...
- [ ] v1対象の4機能（勝率推移 / 得失点差推移 / 月別試合数 / 選手比較（主要5指標））が表示される。
- [ ] 年度フィルタ変更時、4機能すべてが同じ年度条件で再集計される。
- [ ] 試合種別フィルタ変更時、4機能すべてが同じ試合種別条件で再集計される。
- [ ] 既存の成績一覧が従来どおり表示・操作できる（回帰なし）。
- [ ] 既存の選手成績表が従来どおり表示・操作できる（回帰なし）。
